...
function GaleriaDeImagenes() {
  const [imagenes, setImagenes] = useState([
    { src: 'imgs/imagen_1.png', alt: 'Imagen 1', caption: 'Pie de foto Imagen 1' },
    { src: 'imgs/imagen_2.png', alt: 'Imagen 2', caption: 'Pie de foto Imagen 2' },
    { src: 'imgs/imagen_3.png', alt: 'Imagen 3', caption: 'Pie de foto Imagen 3' },
    { src: 'imgs/imagen_4.png', alt: 'Imagen 4', caption: 'Pie de foto Imagen 4' }
  ]);
